...
namespace GetIntoMealPrepAPI.Migrations
{
    ...
    [Migration("20250420101950_UpdateMealPlanEntryToUseUtc")]
    partial class UpdateMealPlanEntryToUseUtc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GetIntoMealPrepAPI.Models.MealPlanEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "Date", "MealType", "Position")
                        .IsUnique();
            ...
            modelBuilder.Entity("GetIntoMealPrepAPI.Models.MealPlanEntry", b =>
                {
                    ...
                    b.HasOne("GetIntoMealPrepAPI.Models.User", "User")
                        .WithMany()
